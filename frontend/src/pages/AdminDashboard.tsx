      ...
      <div className="card">
        ...
        <div className="card-bd">
          <div className="field-row">
            ...
            {periodType === 'Monthly' && (
              <>
                <div className="input-group">
                  <label>Month</label>
                  <select className="select" value={selectedMonth} onChange={(e) => setSelectedMonth(parseInt(e.target.value))}>
          ...
          <div className="btn-row mt16">
            <button className="btn" onClick={handleGenerate} disabled={generatingReport}>
